...
$.extend($.validator, {
	...
	methods: {
		...
		equalTo: function(value, element, param) {
			...
			// NOTE find a way to bind the event just once, avoiding the unbind-rebind overhead
...
;(function($) {
	...
	// NOTE verify if jQuery 1.4's implementation is compatible with older jQuery special-event APIs
